...
public abstract  class CartDatabase extends RoomDatabase {
    ...
    static final Migration MIGRATION_2_3 = new Migration(3, 4) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("CREATE TABLE IF NOT EXISTS Cart (id INTEGER NOT NULL, etiqueta TEXT, link TEXT, cantidad REAL NOT NULL, unidad TEXT, material INTEGER NOT NULL, ancho INTEGER NOT NULL, largo REAL NOT NULL, colores INTEGER NOT NULL, presentacion INTEGER NOT NULL, price REAL NOT NULL, PRIMARY KEY(id))");
        }
    };
